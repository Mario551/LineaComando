...
internal sealed class DocumentMessageInfobipConfiguracion : IEntityTypeConfiguration<DocumentMessageInfobip>
{
    public void Configure(EntityTypeBuilder<DocumentMessageInfobip> builder)
    {
        builder.ToTable("per_document_messages_infobip");
        ...
        builder.HasOne(message => message.InboundMessageInfobip)
            .WithOne(message => message.DocumentMessageInfobip)
            .HasForeignKey<DocumentMessageInfobip>(message => message.RecordIdInboundMessagesInfobip)
