...
internal sealed class VideoMessageInfobipConfiguracion : IEntityTypeConfiguration<VideoMessageInfobip>
{
    public void Configure(EntityTypeBuilder<VideoMessageInfobip> builder)
    {
        builder.ToTable("per_video_messages_infobip");
        ...
        builder.HasOne(message => message.InboundMessageInfobip)
            .WithOne(message => message.VideoMessageInfobip)
            .HasForeignKey<VideoMessageInfobip>(message => message.RecordIdInboundMessagesInfobip)
