...
public class MetadataRazonamientoIALineaConversacionConfiguracion : IEntityTypeConfiguration<DAOMetadataRazonamientoIALineaConversacion>
{
    public void Configure(EntityTypeBuilder<DAOMetadataRazonamientoIALineaConversacion> builder)
    {
        builder.ToTable("per_metadata_razonamiento_ia_linea_conversacion");
