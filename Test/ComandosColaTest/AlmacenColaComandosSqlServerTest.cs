...
namespace ComandosColaTest
{
    ...
    public class AlmacenColaComandosSqlServerTest : BaseIntegracionSqlServerTest
    {
        ...
        [Fact]
        public async Task EncolarAsync_ConDatosJson_DebeGuardarCorrectamente()
        {
            var ruta = PrefijoTest + "encolar_json";
            await PrepararTestAsync(ruta);
