...
namespace EventDrivenTest
{
    ...
    public class RegistroTiposEventoSqlServerTest : BaseIntegracionTestEventDrivenSqlServer
    {
        private readonly RegistroTiposEventoSqlServer _registro;

        protected override string PrefijoTest => "registro_tipos_sql_";
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new RegistroTiposEventoSqlServer(null!));
        }
    }
}
