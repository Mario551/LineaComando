...
namespace EventDrivenTest
{
    ...
    public class ColaEventosPostgresTest : BaseIntegracionTestEventDrivenPostgres
    {
        private readonly ColaEventosPostgres _almacen;
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new ColaEventosPostgres(null!));
        }
    }
}
